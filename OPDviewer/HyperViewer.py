...
class HyperViewer(QMainWindow):
    ...
    def on_calibration_changed(self):
        """Handle change in spatial calibration pixel sizes (X, Y, Z in µm)."""
        self.update_line_profile_plot()

    def get_pixel_scale(self):
        """Returns physical scale of the profile axis in micrometers (µm/px). Defaults to 1.0."""
    ...
    def get_z_scale(self):
        """Returns physical Z step size in micrometers (µm/frame). Defaults to 1.0."""
